...
- [docs/REQUIREMENTS.md](https://github.com/jho951/editor-service/blob/main/docs/REQUIREMENTS.md)
...
- [docs/decisions/](https://github.com/jho951/editor-service/blob/main/docs/decisions/README.md)
  - 채택된 기술 결정과 ADR
- [docs/runbook/](https://github.com/jho951/editor-service/blob/main/docs/runbook/README.md)
  - 재현 가능한 디버깅 절차와 운영 점검 메모
- [docs/roadmap/](https://github.com/jho951/editor-service/blob/main/docs/roadmap/README.md)
...
- 최종 기준을 보여주는 문서는 새 내용을 별도 섹션으로 계속 누적하기보다, 기존 관련 섹션에 통합해 최신 기준이 한 번에 읽히게 갱신한다.
- 다만 검토 과정, 작업 이력, 임시 재개 메모처럼 경과 보존이 목적 문서는 기존 기록을 덮어쓰는 방식으로 통합하지 않는다.
...
- 요구사항으로 확정된 내용은 최종적으로 [docs/REQUIREMENTS.md](https://github.com/jho951/editor-service/blob/main/docs/REQUIREMENTS.md)에 반영한다.
- 아직 채택되지 않은 비교나 검토는 [docs/discussions/](https://github.com/jho951/editor-service/blob/main/docs/discussions/README.md)에 남긴다.
- 실제로 채택된 결정만 [docs/decisions/](https://github.com/jho951/editor-service/blob/main/docs/decisions/README.md) ADR로 승격한다.
- 디버깅/장애 재현 절차는 [docs/runbook/](https://github.com/jho951/editor-service/blob/main/docs/runbook/README.md)에 남긴다.
- 개인 학습용 설명과 개인 트러블슈팅 기록은 [docs/learn/](https://github.com/jho951/editor-service/blob/main/docs/learn/README.md)에 남긴다.
- 설명 문서와 구현 가이드는 [docs/explainers/](https://github.com/jho951/editor-service/blob/main/docs/explainers/README.md), [docs/guides/](https://github.com/jho951/editor-service/blob/main/docs/guides/README.md)의 경계를 지킨다.
